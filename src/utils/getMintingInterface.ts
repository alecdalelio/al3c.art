...
import MinterSetPriceV4Interface from "components/MinterInterfaces/MinterSetPriceV5Interface";
...
export const getMintingInterface = (
  contractVersion: string,
  minterType: string | null
) => {
  if (contractVersion === "V2") {
    ...
    if (minterType === "MinterSetPriceERC20V4")
      return MinterSetPriceERC20V4Interface;
    if (minterType === "MinterDAExpSettlementV1")
      return MinterDAExpSettlementV1Interface;
  }
  return null;
};
